...
import type { TokenizedCode } from "./code-highlight";
import { createRawTokens, highlightCode } from "./code-highlight";
...
export const CodeBlockContent = ({
  ...
  // Async highlighting result (populated after shiki loads lazily)
...
export const CodeBlockLanguageSelectorContent = ({
  ...
  <SelectContent className={cn("max-h-64", className)} {...props} />
);
